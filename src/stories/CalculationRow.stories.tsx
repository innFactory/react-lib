...
storiesOf('CalculationRow', module)
	.add('enabled with €', () => {
		return withTheme(
			<Paper style={{ margin: 20, maxWidth: 500 }}>
				<CalculationRowWithProps editable label="Eigenkapital" units={['€']} value={100000} />
	...
	.add('enabled with € and %', () => {
		return withTheme(
			<Paper style={{ margin: 20, maxWidth: 500 }}>
				<CalculationRowWithProps editable label="Eigenkapital" units={['€', '%']} />
			</Paper>
		);
	})
	...
	.add('misc with border and colors', () => {
		return withTheme(
			<Paper style={{ margin: 20, maxWidth: 500 }}>
				...
				/>
				<CalculationRowWithProps value={1000} label="Eigenkapital" units={['€']} bold />
			</Paper>
		);
	})

import { createStyles, Theme, WithStyles, withStyles, Popper } from '@material-ui/core';
import Typography from '@material-ui/core/Typography';
import * as React from 'react';
import MUISlider from '../slider/Slider/Slider';
...
class StyledSlider extends React.Component<StyledSlider.Props, StyledSlider.State> {
    ...
    handleChange = (event: any, value: any) => {
        var x = event;
        const newRoundedValue = Math.round(value / this.props.step) * this.props.step;
    ...
    getTrackBeforeClass = () => {
        ...
        if (beforeClass === 'primary') {
            return this.props.classes.trackBeforePrimary;
        }
        if (beforeClass === 'secondary') {
            return this.props.classes.trackBeforeSecondary;
        }
        return this.props.classes.trackBefore;
    }
            ...
            <div style={{ margin: 100 }}>
                <MUISlider
                    ...
                    thumb={
                        <div
                            ...
                            onTouchCancelCapture={() => this.setState({ anchorEl: undefined })}
                            ...
                            style={{
                                ...
                                backgroundColor: this.getOr(this.props.thumbBackgroundColor, 'white'),
                        ...
                        >
                            {<Typography
                                variant="h4"
                                style={this.state.anchorEl !== undefined ?
                                    {
                                        color: this.getOr(this.props.thumbBackgroundColor, 'white'),
                                        touchAction: 'none'
                                    } :
                                    { touchAction: 'none' }}
                            >
                ...
                >
                    <div
                        ...
                        style={
                            {
                                backgroundColor: this.getOr(this.props.popperCardBackgroundColor, 'white'),
